...
| Agent Teams | https://code.claude.com/docs/en/agent-teams | 2026-04-04 | Multi-agent patterns |
| MCP | https://code.claude.com/docs/en/mcp | 2026-04-04 | MCP server configuration |
| Scheduled Tasks | https://code.claude.com/docs/en/scheduled-tasks | 2026-04-04 | Cron, scheduled agents, /loop |
